...
namespace Vileve.Infra.Data.Migrations
{
    ...
    [Migration("20210126041414_Add_TableClientesDependentes")]
    partial class Add_TableClientesDependentes
    {
            ...
            modelBuilder.Entity("Vileve.Domain.Models.Cliente", b =>
                {
                    ...
                    b.HasIndex("ConsultorId")
                        .IsUnique()
                        .HasFilter("[ConsultorId] IS NOT NULL");
            ...
            modelBuilder.Entity("Vileve.Domain.Models.Cliente", b =>
                {
                    b.HasOne("Vileve.Domain.Models.Consultor", "Consultor")
                        .WithOne()
                        .HasForeignKey("Vileve.Domain.Models.Cliente", "ConsultorId")
